...
// Generated from PDK cell declarations with parsed input/output directions.
// VNW/VPW are added for OpenLane/TinyTapeout powered netlists.
...
module gf180mcu_fd_sc_mcu7t5v0__aoi222_2(ZN, C2, C1, B2, B1, A1, A2, VDD, VNW, VPW, VSS);
  input C2, C1, B2, B1, A1, A2, VNW, VPW;
  inout VDD, VSS;
  output ZN;
  assign ZN = ~((A1 & A2) | (B1 & B2) | (C1 & C2));
endmodule
...
module gf180mcu_fd_sc_mcu7t5v0__mux4_1(I2, S0, I3, Z, S1, I1, I0, VDD, VNW, VPW, VSS);
  input I2, S0, I3, S1, I1, I0, VNW, VPW;
  inout VDD, VSS;
  output Z;
...
module gf180mcu_fd_sc_mcu7t5v0__sdffrsnq_1(SE, SI, D, CLK, SETN, RN, Q, VDD, VNW, VPW, VSS);
  input SE, SI, D, CLK, SETN, RN, VNW, VPW;
  inout VDD, VSS;
  output reg Q;
endmodule
...
module gf180mcu_fd_sc_mcu7t5v0__sdffsnq_1(SE, SI, D, CLK, SETN, Q, VDD, VNW, VPW, VSS);
  input SE, SI, D, CLK, SETN, VNW, VPW;
  inout VDD, VSS;
  output reg Q;
endmodule
